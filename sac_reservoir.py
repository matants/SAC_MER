...
class ReservoirSAC(ReservoirOffPolicyAlgorithm):
    """
    ...
    def _setup_model(self) -> None:
        super(ReservoirSAC, self)._setup_model()
        ...
        if isinstance(self.ent_coef, str) and self.ent_coef.startswith("auto"):
            ...
            self.ent_coef_optimizer = th.optim.Adam([self.log_ent_coef], lr=self.lr_schedule(1))  #TODO: change to optimizer of policy and actor (policy_kwargs[optimizer_class])
        else:
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(ReservoirSAC, self)._excluded_save_params() + ["actor", "critic", "critic_target"]
