...
class SACMER_Q(SACMER):
    ...
    def train_mer(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        optimizers_to_reset = [self.critic.optimizer]
        ...
        # Save initial weights of model - ONLY FOR CRITIC
        models_to_update = [self.critic]
        ...
        # Perform Reptile step - ONLY ON VALUES
...
class SACMER_P(SACMER):
    ...
    def train_mer(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        optimizers_to_reset = [self.actor.optimizer, self.ent_coef_optimizer]
        ...
        # Save initial weights of model - ONLY FOR ACTOR
        models_to_update = [self.actor]
        initial_state_dicts = [deepcopy(model.state_dict()) for model in models_to_update]
        ...
        # Perform Reptile step - ONLY ON Policy
        for i_model, model in enumerate(models_to_update):
            self.reptile_step_state_dict(model, initial_state_dicts[i_model])
